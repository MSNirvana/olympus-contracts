...
contract CrusaderBondDepository is Ownable {
    ...
    function deposit( 
        ...
        if(principle == wbnb){
            ...
            WBCH(wbnb).deposit{value: _amount}();
        } else {
        ...
        require( payout <= maxPayout() || maxPayout() == 0, "Bond too large"); // size protection because there is no slippage
